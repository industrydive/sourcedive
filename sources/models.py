...
class Person(BasicInfo, PrivacyMixin):
    ...
    exportable_by_dive = models.ManyToManyField(Dive, blank=True, related_name='exportable_dive', help_text='These are the dives that can export this source.', verbose_name='Exportable by (Dive)')
    exportable_by_user = models.ManyToManyField(User, blank=True, related_name='exportable_user', help_text='These are the users who can export this source.', verbose_name='Exportable by (User)')
